...
export class ValidationErrorComponent {
  ...
  get hasError() {
    return this.errors && !!this.errors[this.error];
  }
  ...
  private get valueControl() {
    return this.fieldService?.valueControlName ? this.formGroup?.get(this.fieldService.valueControlName) as FormControl : undefined;
  }

  private get control() {
    return this.name ? this.formGroup?.get(this.name) as FormControl : this.formGroup;
  }
